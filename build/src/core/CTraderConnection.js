...
class CTraderConnection {
    constructor({ host, port, }) {
        ...
        __classPrivateFieldGet(this, _CTraderConnection_encoderDecoder, "f").setDecodeHandler((data) => this.onDecodedData(__classPrivateFieldGet(this, _CTraderConnection_protobufReader, "f").decode(data)));
        ...
        __classPrivateFieldGet(this, _CTraderConnection_socket, "f").onData = (data) => this.onData(data);
        __classPrivateFieldGet(this, _CTraderConnection_socket, "f").onClose = () => this.onClose();
        __classPrivateFieldGet(this, _CTraderConnection_socket, "f").onError = () => this.onError();
    }
    isConnecting() {
        if (!__classPrivateFieldGet(this, _CTraderConnection_socket, "f").tlsSocket) {
            return false;
        }
        return __classPrivateFieldGet(this, _CTraderConnection_socket, "f").tlsSocket.connecting;
    }
    ...
    sendCommand(payloadName, data, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientMsgId = messageId !== null && messageId !== void 0 ? messageId : (0, uuid_1.v1)();
